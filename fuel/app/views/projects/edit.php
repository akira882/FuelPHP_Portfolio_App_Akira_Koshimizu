...
<head>
    <meta charset="utf-8">
    <title>Edit Project | TaskBoard</title>
    <style>
    ...
    <div class="container">
        ...
        <?php echo Form::csrf(); ?>
            ...
            <div class="form-group">
                <label>Project Name <span style="color: #ff7b72;">*</span></label>
            ...
            <div class="form-group">
                ...
                <input type="date" name="due_date" value="<?php echo $project->due_date ? date('Y-m-d', $project->due_date) : ''; ?>">
            </div>

            <div class="buttons">
                <button type="submit" class="btn btn-primary">Update Project</button>
                <a href="<?php echo Uri::create('projects'); ?>" class="btn btn-secondary">Cancel</a>
            </div>
